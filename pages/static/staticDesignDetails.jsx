                    ...
                    <article className="blog-post">
                        ...
                        <div className="row align-items-start">
                            <div className="col-auto d-none d-lg-block">
                                <img property="schema:image" src="https://dev-training-decouple-drupal.pantheonsite.io/sites/default/files/styles/large/public/2022-05/c15193ca-0f87-44b4-8670-740818d15b35.jpeg?itok=Yu4XsHiO" width="300" height="250" alt="Defence Secretary, Ben Wallace speaks during the Defence of Europe conference at King's College London in central London, on May 9. (Dominic Lipinski/PA Images/Getty Images)" loading="lazy" typeof="foaf:Image" className="image-style-medium"></img>
                            </div>
                            <div className="col">
...
export default staticDesignDetails;
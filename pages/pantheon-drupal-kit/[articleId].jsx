...
export default function nextDrupalArticle( { articleFromApi } ) {
    ...
    return (
        <div>
            ...
            <div className="mt-4" > 
                <h3>{ articleFromApi && <div dangerouslySetInnerHTML={{ __html: articleFromApi.title }} /> }</h3>
            </div>

            <div className="mt-4" > 
                { articleFromApi && <div dangerouslySetInnerHTML={{ __html: articleFromApi.body.value }} /> }
            </div>
